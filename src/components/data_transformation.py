...
class DataTransformationConfig:
    preprocessor_obj_file_path = os.path.join('artifacts',"preprocsser.pkl")
...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        ...
        """
            This function is based on  the data transformation which include 
            numerical columns and catagorical columns as CSV
        """
        try:
            ...
            num_pipeline = Pipeline(
                steps=[
                    ("immuter",SimpleImputer(strategy='median')),
                    ('sclaer',StandardScaler(with_mean=False))]
            )

            cat_pipeline = Pipeline(
                 steps=[
                    ("immuter",SimpleImputer(strategy='most_frequent')),
